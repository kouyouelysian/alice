...
available functions:
	...
	bmco.xml.nodeGetByAttributeValue(xmldoc, nodeTag, attributeName, attributeValue)
...
return: <xml element> or null if not found
*/
nodeGetByAttributeValue: function(xmldoc, nodeTag, attributeName, attributeValue)
{
	var tags = xmldoc.getElementsByTagName(nodeTag);
	for (var t = 0; t < tags.length; t++)
	{
